...
const MainLayout: React.FC<MainLayoutProps> = ({ children, userEmail, userProfilePic, onLogout }) => {
    return (
        <div className="flex h-screen bg-[#fcfdfc] overflow-hidden">
            ...
            <main className="flex-1 flex flex-col overflow-hidden relative">
                ...
                <Header userEmail={userEmail} userProfilePic={userProfilePic} onLogout={onLogout} />
